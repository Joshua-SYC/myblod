...
export default {
  ...
  data () {
    return {
      ...
      myTheme: THEME,
      themeName: ['tsumiki','blackCat', 'whiteCat', 'haru1', 'haru2', 'haruto', 'koharu', 'izumi', 'shizuku', 'wanko', 'miku', 'z16','miku'],
      // 模型地址
      model: { 
        tsumiki:
          'https://joshua-syc.github.io/myblod/assets/packages/live2d-widget-model-tsumiki/assets/tsumiki.model.json',
        blackCat:
